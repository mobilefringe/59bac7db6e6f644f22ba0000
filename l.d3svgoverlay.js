...
L.D3SvgOverlay = (L.version < "1.0" ? L.Class : L.Layer).extend({
    ...
    _zoomChange: function (evt) {
        ...
        // this._disableLeafletRounding();
        var newZoom = this._undef(evt.zoom) ? this.map._zoom : evt._zoom; // "viewreset" event in Leaflet has not zoom/center parameters like zoomanim
        ...
        // this._enableLeafletRounding();
        console.log("viewreset",("transform", shift.concat(scale).join("")));
    },
